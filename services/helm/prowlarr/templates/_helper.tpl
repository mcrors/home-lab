...
{{/*
Name of the PVC the pod should mount.
Either the user-specified existing claim, or the chart-generated one.
Only meaningful when persistence.enabled is true.
*/}}
{{- define "prowlarr.pvcName" -}}
{{- if .Values.persistence.existingClaim }}
{{- .Values.persistence.existingClaim }}
{{- else }}
{{- include "prowlarr.fullname" . }}
{{- end }}
{{- end }}
